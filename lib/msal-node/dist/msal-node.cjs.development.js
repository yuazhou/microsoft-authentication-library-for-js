...
var Storage = /*#__PURE__*/function (_CacheManager) {
  ...
  _proto.setItem = function setItem(key, value, type) {
    ...
    switch (type) {
      ...
      case msalCommon.CacheSchemaType.APP_META_DATA:
        {
  ...
  _proto.createAuthority = function createAuthority(authorityString) {
    try {
      ...
      if (authorityString) {
        ...
        authority = msalCommon.AuthorityFactory.createInstance(authorityString, _this12.config.system.networkClient);
      } else {
      ...
      return Promise.resolve(_catch(function () {
        ...
        throw msalCommon.ClientAuthError.createEndpointDiscoveryIncompleteError(error);
      }));
    } catch (e) {
      return Promise.reject(e);
    }
