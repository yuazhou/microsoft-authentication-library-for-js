import { BroadcastService, MsalService, MsalAngularConfiguration } from './public-api';
...
import { MSAL_CONFIG, MSAL_CONFIG_ANGULAR } from './lib/msal.service';
import { RouterTestingModule } from '@angular/router/testing';
import {} from 'jasmine';
import { Configuration, UserAgentApplication, AuthResponse, AuthError } from 'msal';

describe('Msal Angular Pubic API tests', () => {
    ...
    describe('loginPopup', () => {
        it('success', done => {
            ...
            broadcastService.subscribe('msal:loginSuccess', (payload: AuthResponse) => {
                // @ts-ignore
                expect(payload.idToken.rawIdToken).toBe(sampleIdToken.idToken.rawIdToken);
            ...
            .then((response: AuthResponse) => {
                expect(response.idToken.rawIdToken).toBe(sampleIdToken.idToken.rawIdToken);
            });
